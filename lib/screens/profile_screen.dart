...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final syllable = syllables('beautiful'); // 3
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          _isLoggedIn
              ? _buildUserInfo(textTheme, colorScheme)
              : _buildLoginPrompt(context, colorScheme, textTheme),
          const Divider(),
          // Menu entries
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          Text(
            'Access orders, addresses, and more',
